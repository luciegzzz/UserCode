...
void checkNvtxPUNVtxRecoMatch(){
  ...
  TH2I  *nrVtxPU0 = new TH2I("nrVtxPU0", "number of reco primary vertices vs nr of PU vertices", 25, 0 ,25, 25, 0, 25);
  ...
  nrVtxPU0 -> Draw("colz");
   ...
   TH2I  *nrVtxPU5 = new TH2I("nrVtxPU5", "number of reco primary vertices vs nr of PU vertices", 25, 0 ,25, 25, 0, 25);
   ...
   TH2I  *nrVtxPU10 = new TH2I("nrVtxPU10", "number of reco primary vertices vs nr of PU vertices", 25, 0 ,25, 25, 0, 25);
   ...
   TH2I  *nrVtxPU15 = new TH2I("nrVtxPU15", "number of reco primary vertices vs nr of PU vertices", 25, 0 ,25, 25, 0, 25);
   ...
   TH2I  *nrVtxPU20 = new TH2I("nrVtxPU20", "number of reco primary vertices vs nr of PU vertices", 25, 0 ,25, 25, 0, 25);
   ...
   TH2I  *nrVtxPU25 = new TH2I("nrVtxPU25", "number of reco primary vertices vs nr of PU vertices", 25, 0 ,25, 25, 0, 25);
   ...
   TH2I  *nrVtxAllPU = new TH2I("nrVtxAllPU", "number of reco primary vertices vs nr of PU vertices", 25, 0 ,25, 25, 0, 25);
