...
#process.load("METsWithPU.METsAnalyzer.source_QCD_Pt_15to3000_Flat_FlatDist10_Spring2011_cfi")

process.load("METsWithPU.METsAnalyzer.metsanalyzer_cfi")

process.analysis.HistOutFile = cms.untracked.string('plots.root')
