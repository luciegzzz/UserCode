...
process.source = datasetToSource(
 ...
 ##  '/QCD_HT-100To250_TuneZ2star_8TeV-madgraph-pythia/Summer12-PU_S7_START52_V9-v1/AODSIM/V5_B/PAT_CMG_V5_6_0_B',
 ##  '/QCD_HT-250To500_TuneZ2star_8TeV-madgraph-pythia6/Summer12-PU_S7_START52_V9-v1/AODSIM/V5_B/PAT_CMG_V5_6_0_B',
##    '/QCD_HT-500To1000_TuneZ2star_8TeV-madgraph-pythia6/Summer12-PU_S7_START52_V9-v1/AODSIM/V5_B/PAT_CMG_V5_6_0_B',
##    '/TTJets_TuneZ2star_8TeV-madgraph-tauola/Summer12-PU_S7_START52_V9-v1/AODSIM/V5_B/PAT_CMG_V5_6_0_B',
   'cmgTuple_.*root'
   )
...
process.load('Lucie.ThirdGeneration.selectHadronicDecay_cff')
process.load('Lucie.ThirdGeneration.fatjets_cff')
process.load('Lucie.ThirdGeneration.topCandidatesSelection_cff')
process.load('Lucie.ThirdGeneration.mergingTopCandidates_cff')

process.pAllHadronic = cms.Path(
    process.selectHadronicDecaySequence     + # select all hadr 
    process.fatjetsSequence                 + # cluster jets
    process.topCandidatesSelectionSequence  + #select top candidates : basic jets -> top jets (with top tag) + select "good" candidates in each collection
    process.mergingTopCandidatesSequence      #merge top cands
    )
