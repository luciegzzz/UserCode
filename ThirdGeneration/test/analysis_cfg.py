...
ana = cfg.Analyzer(
    'Analysis',
   # topCandidates = "topCandidatesAkt0p71p75"
    topCandidates = "topCandidatesCa0p71p75",
    verbose = False,
    )


filesT2tt = getFiles('/SMS-T2tt_FineBin_Mstop-225to1200_mLSP-0to1000_8TeV-Pythia6Z/Summer12-START52_V9_FSIM-v1/AODSIM/V5_B/PAT_CMG_V5_6_0_B/TOP_V1/', 'lucieg', 'topTuple_.*root')[1:2]
...
## filesQCDHT1000Inf = getFiles('/QCD_HT-1000ToInf_TuneZ2star_8TeV-madgraph-pythia6/Summer12-PU_S7_START52_V9-v1/AODSIM/V5_B/PAT_CMG_V5_6_0_B/TOP/','lucieg', 'skim_.*root')
