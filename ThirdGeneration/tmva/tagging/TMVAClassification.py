...
# --------------------------------------------
ext = "Tagging_Nov15QCD1000Infasbkg"
# Default settings for command line arguments
DEFAULT_OUTFNAME = "TMVA"+ext+".root"
DEFAULT_INFNAME_S= "../../test/FatJetsSamples/T2tt/FatJetsTreeAnalyzer/FatJetsTreeAnalyzer_tree.root"
#DEFAULT_INFNAME_B= "../../test/FatJetsSample/T2tt/FatJetsTreeAnalyzer/FatJetsTreeAnalyzer_tree.root"
DEFAULT_INFNAME_B= "../../test/FatJetsSamples/QCDHT1000Inf/FatJetsTreeAnalyzer/FatJetsTreeAnalyzer_tree.root"
DEFAULT_TREESIG  = "FatJetsTreeAnalyzer"
DEFAULT_TREEBKG  = "FatJetsTreeAnalyzer"
...
DEFAULT_METHODS  = "Cuts,CutsD,LikelihoodD,BDT,BDTD,BDTG"
...
def main():
    ...
    infnameS     = DEFAULT_INFNAME_S
    infnameB     = DEFAULT_INFNAME_B
    ...
    for o, a in opts:
        if o in ("-?", "-h", "--help", "--usage"):
            ...
            methods = a
        elif o in ("--is", "--inputfilesignal"):
            infnameS = a
        elif o in ("--ib", "--inputfilebackground"):
            infnameB = a
    ...
    factory = TMVA.Factory( "TMVAClassification"+ext, outputFile, 
    ...
    factory.AddVariable( "pt", "top candidate pt", "GeV", 'F' );
    factory.AddVariable( "eta", "top candidate eta", "", 'F' );
    factory.AddVariable( "mass", "top candidate mass", "GeV", 'F' );
    factory.AddVariable( "radius", "top candidate radius", "", 'F' );
    factory.AddVariable( "sumPtOvernConst", "top candidate sumPtOvernConst ", "", 'F' );
    factory.AddVariable( "firstBtag_btag", "firstBtag_btag", "", 'F' );
    factory.AddVariable( "firstBtag_pt", "firstBtag_pt", "", 'F' );
    factory.AddVariable( "firstBtag_mass", "firstBtag_mass", "", 'F' );
    factory.AddVariable( "secondBtag_btag", "secondBtag_btag", "", 'F' );
    factory.AddVariable( "secondBtag_pt", "secondBtag_pt", "", 'F' );
    factory.AddVariable( "secondBtag_mass", "secondBtag_mass", "", 'F' );
...
##     factory.AddSpectator( "spec2:=var1*3",  "Spectator 2", "units", 'F' )
    ...
    # Read input data
    if gSystem.AccessPathName( infnameS ) != 0 or gSystem.AccessPathName( infnameB ):
        print 'input files not found', infnameS, infnameB
        
    inputS = TFile.Open( infnameS )
    inputB = TFile.Open( infnameB )
   ...
   # Multi-dimensional likelihood estimator using self-adapting phase-space binning
    ...
    if "BDTG" in mlist:
        factory.BookMethod( TMVA.Types.kBDT, "BDTG",
                            "!H:!V:NTrees=1000:BoostType=Grad:Shrinkage=0.30:UseBaggedGrad:GradBaggingFraction=0.6:SeparationType=GiniIndex:nCuts=20:NNodesMax=5:VarTransform=N" )
    ...
    if "BDTD" in mlist:
        factory.BookMethod( TMVA.Types.kBDT, "BDTD",
                            "!H:!V:NTrees=400:nEventsMin=400:MaxDepth=3:BoostType=AdaBoost:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning:VarTransform=Decorrelate,N" )
