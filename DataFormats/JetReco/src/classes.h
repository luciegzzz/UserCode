...
#include "DataFormats/JetReco/interface/BasicJetCollection.h" 
#include "DataFormats/JetReco/interface/TopJetCollection.h" 
...
namespace {
  struct dictionary {
    ...
    reco::TopJetCollection o3bis;
    reco::TopJetRef r3bis;
    reco::TopJetFwdRef fwdr3bis;
    reco::TopJetFwdPtr fwdp3bis;
    reco::TopJetRefVector rr3bis;
    reco::TopJetFwdRefVector fwdrr3bis;
    reco::TopJetFwdPtrVector fwdrp3bis;
    reco::TopJetRefProd rrr3bis;
    edm::Wrapper<reco::TopJetCollection> w3bis;
    edm::Wrapper<reco::TopJetRefVector> wrv3bis;
    edm::Wrapper<reco::TopJetFwdRefVector> wfwdrv3bis;
    edm::Wrapper<reco::TopJetFwdPtrVector> wfwdpv3bis;
    edm::reftobase::Holder<reco::Candidate, reco::TopJetRef> rtb3bis;
    reco::JetTrackMatch<reco::TopJetCollection> jtm3bis;
    ...
    edm::reftobase::Holder<reco::Jet, reco::TopJetRef> htopj;
    ...
    edm::reftobase::RefHolder<reco::TopJetRef> rhtopj;
    ...
    edm::Ptr<reco::TopJet> ptrtopj;
    edm::PtrVector<reco::TopJet> ptrvtopj;
