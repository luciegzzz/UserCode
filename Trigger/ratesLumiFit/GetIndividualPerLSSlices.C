...
void GetIndividualPerLSSlices(int runNr,const char* DS="Mu"){

  //char text[500];

  // //for template
  TString dir                     = TString::Format("r%d/",runNr); ///in fact would be better to give runNr as an arg. cf GetSlopesInterceptsMultRuns.C
  TString filenameDS              = TString::Format("hltmenu_7TeV_2.0e29_startup_RatesLumiFit_%s_r%d.root",DS,runNr);
  cout<<"file DS "<<filenameDS<<endl;
  TString fileInNameMinBias       = TString::Format("hltmenu_7TeV_2.0e29_startup_RatesLumiFit_MB_r%d.root",runNr);
  
  // TString fileInNameMinBias       = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_MB.root" 
  // TString fileInNameMu            = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_Mu.root" 
  // TString fileInNameMuMonitor     = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_MuMon.root" 
  // TString fileInNameEG            = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_EG.root" 
  // TString fileInNameEGMonitor     = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_EGMon.root" 
  // TString fileInNameJMT           = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_JMT.root" 
  // TString fileInNameJMTMonitor    = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_JMTMon.root" 
  // TString fileInNameCommissioning = dir+"hltmenu_7TeV_2.0e29_startup_RatesLumiFit_Comm.root" 
...
//   TString fileInNameCommissioning   = dir+"hltmenu_7TeV_1.0e29_startup_2010Jun17_r137028_Comm.root";
...
//   TString fileInNameCommissioning   = dir+"hltmenu_7TeV_1.0e29_startup_HLT_LowInt_2E29-V2_r136100_Commissioning.root";
  ...
  TFile* fMB = TFile::Open(dir+fileInNameMinBias);
  TFile* f   = TFile::Open(dir+filenameDS);
...
//   if (DS==TString("Comm" ))  f = TFile::Open(fileInNameCommissioning);
  ...
  double rebinFactor=nLumiSec/10;
