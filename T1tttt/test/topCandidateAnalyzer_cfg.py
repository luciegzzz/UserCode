...
ana = cfg.Analyzer(
    ...
    verbose = False,
    jetMassParametersFile = 'JetMassT2tt/T2tt/JetMassAnalyzer/fitParameters.txt',
    jetCollections = {
...
T2tt = cfg.MCComponent(
    name = 'T2tt',
    files = files,
#    files = '/data/lucieg/boostedTops/NoPU/533/topTupleAllHadronic_T2tt_FatJetsFromGen.root',
    xSection = 1., 
    nGenEvents = 1,
    triggers = [],
    effCorrFactor = 1 )
...
TTJets = cfg.MCComponent(
    name = 'TTJets',
    files = '/data/lucieg/boostedTops/NoPU/533/topTupleAllHadronic_300_400.root',
    xSection = 1., 
    nGenEvents = 1,
    triggers = [],
    effCorrFactor = 1 )
